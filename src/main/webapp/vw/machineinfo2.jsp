...
<div class="row">
    ...
    const Cpuchart = new Chart(ctx, {
      ...
      data: {
        labels: [<%=Fetchlast.gettimeinfo("vmm-2")%>], // X-axis labels
        datasets: [{
          label: 'Cpu',
          data: [<%=Fetchlast.getcpu("vmm-2")%>],  // Y-axis data
    ...
    const Memchart = new Chart(ctx1, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Memory',
          data: [<%=Fetchlast.getmem("vmm-2")%>],  // Y-axis data
          borderColor: 'rgba(75, 192, 192, 1)',
          backgroundColor: 'rgba(75, 192, 192, 0.2)',
          borderWidth: 2
        }]
    ...
    const Diskchart = new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Disk',
          data: [<%=Fetchlast.getdisk("vmm-2")%>],  // Y-axis data
          borderColor: 'rgba(75, 192, 192, 1)',
          backgroundColor: 'rgba(75, 192, 192, 0.2)',
          borderWidth: 2
        }]
