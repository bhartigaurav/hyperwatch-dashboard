...
<%@page import="com.aemcentral.hyperwatch.dashboard.encryption.*"%>
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              <div class="col-md-5 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mt-5">
                     <h5>Authentication Service URL:</h5>
                    <code> <%=Secrets.getAuthurl() %></code>
                    </div>
                   <div class="mt-3">
                     <h5>Database URL:</h5>
                    <code><%=Credentials.getDburl() %></code> 
                    </div>
              ...
              <div class="col-md-7 grid-margin stretch-card">
                                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Dashboard Logs</h4>
...
Scanner sc = new Scanner(file);
	...
	Logg.writetofile("at admin/dashboard-settings.jsp Exception Handled ERROR While Reading File"+filepath+"", 2);
}
	%>
...
<a href="tail-logs.jsp" target="_blank">View Full Logs</a>
